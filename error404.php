<?php
    $title = 'Página não encontrada - Associação Atlética Ferroviária - Pindamonhangaba';
    include_once 'classes/head.inc.php';
?>
        <h1 class="mt-10 ml-4 text-uppercase font-weight-bold"><i class="fas fa-times"></i> 404 - Página não encontrada</h1>
        <!-- Start Main Content -->
            ...
            <section class="col-md-8 col-sm-12">
                ...
                try {
                    ...
                    $getNews = $connect->prepare('
                                        select tbl_news.nwsId, nwsTitle, nwsDescription, nwsDate, nwsImageSmall 
                     ...
                     * nwsImgeSmall - 4
                     */
                    // For each post, show his content in html
                            ...
                            <a href="noticia?n=<?php echo $show[0]; ?>" class="text-decoration-none">
                                <div class="row">
                                    <div class="col-sm-12 col-md-4 col-lg-3">
                                        <img class="card-img-horizontal" src="<?php echo $show[4]; ?>" alt="Lorem Ipsum">
                                    </div>
